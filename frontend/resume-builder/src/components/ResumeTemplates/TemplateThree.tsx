...
const TemplateThre: FC<TemplateOneProps> = ({
  resumeData,
  colorPallete,
  containerWidth,
}) => {
  const themeColors = colorPallete?.length ? colorPallete : DEFAULT_THEME;
    ...
    >
      ...
      <div className='px-10 pt-10 pb-5'>
        <div className='flex items-start gap-5 mb-5'>
          <div
            className='w-[140px] h-[140px] max-w-[140px] max-h-[140px] rounded-2xl flex items-center justufy-center'
